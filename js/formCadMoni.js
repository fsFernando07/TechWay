...
const submitCadMon = document.querySelector("#cadastrarMon");
...
proxBtnThirdMoni.addEventListener("click", function(){
    ...
    if(certoMoni[0].style.display == '' || certoMoni[1].style.display == ''){
        erroMoni[9].style.display = 'block';
        numErro += 1;
    }
...
submitBtnMoni.addEventListener("click", function(){
    ...
    erroMoni[15].style.display = 'none';
    erroMoni[16].style.display = 'none';
    ...
    if(inputSenhaMoni.value == ''){
        erroMoni[13].style.display = 'block';
        numErro += 1;
    }else if(inputSenhaMoni.value.length < 6){
        erroMoni[14].style.display = 'block';
        numErro += 1;
    }

    if(inputConfSenhaMoni.value == ''){
        erroMoni[15].style.display = 'block';
        numErro += 1;
    }else if(inputConfSenhaMoni.value != inputSenhaMoni.value){
        erroMoni[16].style.display = 'block';
        numErro += 1;
    }
