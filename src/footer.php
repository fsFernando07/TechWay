<footer class="footer">
    <section class="container d-flex justify-content-sm-between align-items-center">
        ...
        <section class="d-flex flex-column align-items-center">
            ...
            <section>
                <a href="/TechWay/src/termosUso.php" class="linkFooter pe-2"> Termos de uso </a>
                <a href="/TechWay/src/politicaPrivacidade.php" class="linkFooter"> Política de privacidade e cookies </a>
            </section>
        </section>
